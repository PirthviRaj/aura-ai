...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "keep-bright bg-ember-btn text-primary-foreground shadow-glow hover:brightness-110 hover:shadow-glow-lg",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-white/10 border border-white/5",
        outline:
          "border border-white/10 bg-transparent text-foreground hover:bg-primary/10 hover:border-primary/40",
        ghost: "text-foreground hover:bg-primary/10 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        glow: "keep-bright bg-ember-btn text-white shadow-[0_0_24px_rgba(255,77,0,0.45)] hover:shadow-[0_0_40px_rgba(255,77,0,0.65)]",
      },
      size: {
